                ...
                if (!preg_match("/\d+\/\d+\/\d+/", $data)) {
                    if ($data == '__true__') {
                        ...
                        if ($text) {
                            ...
                            } else if (preg_match("!^(?<id>\d+) stop (?<ip>[a-zA-Z0-9\.-]+:\d+)$!", $text, $preg)) {
                                $match = \eBot\Manager\MatchManager::getInstance()->getMatch($preg["ip"]);
                                if ($match) {
                            ...
                            } else if (preg_match("!^(?<id>\d+) passknife (?<ip>[a-zA-Z0-9\.-]+:\d+)$!", $text, $preg)) {
                                $match = \eBot\Manager\MatchManager::getInstance()->getMatch($preg["ip"]);
                                if ($match) {
                            ...
                            } else if (preg_match("!^(?<id>\d+) forceknife (?<ip>[a-zA-Z0-9\.-]+:\d+)$!", $text, $preg)) {
                                $match = \eBot\Manager\MatchManager::getInstance()->getMatch($preg["ip"]);
                                if ($match) {
                            ...
                            } else if (preg_match("!^(?<id>\d+) forceknifeend (?<ip>[a-zA-Z0-9\.-]+:\d+)$!", $text, $preg)) {
                                $match = \eBot\Manager\MatchManager::getInstance()->getMatch($preg["ip"]);
                                if ($match) {
                            ...
                            } else if (preg_match("!^(?<id>\d+) forcestart (?<ip>[a-zA-Z0-9\.-]+:\d+)$!", $text, $preg)) {
                                $match = \eBot\Manager\MatchManager::getInstance()->getMatch($preg["ip"]);
                                if ($match) {
                            ...
                            } else if (preg_match("!^(?<id>\d+) stopback (?<ip>[a-zA-Z0-9\.-]+:\d+)$!", $text, $preg)) {
                                $match = \eBot\Manager\MatchManager::getInstance()->getMatch($preg["ip"]);
                                if ($match) {
                            ...
                            } else if (preg_match("!^(?<id>\d+) pauseunpause (?<ip>[a-zA-Z0-9\.-]+:\d+)$!", $text, $preg)) {
                                $match = \eBot\Manager\MatchManager::getInstance()->getMatch($preg["ip"]);
                                if ($match) {
                            ...
                            } else if (preg_match("!^(?<id>\d+) fixsides (?<ip>[a-zA-Z0-9\.-]+:\d+)$!", $text, $preg)) {
                                $match = \eBot\Manager\MatchManager::getInstance()->getMatch($preg["ip"]);
                                if ($match) {
                            ...
                            } else if (preg_match("!^(?<id>\d+) streamerready (?<ip>[a-zA-Z0-9\.-]+:\d+)$!", $text, $preg)) {
                                $match = \eBot\Manager\MatchManager::getInstance()->getMatch($preg["ip"]);
                                if ($match) {
                            ...
                            } else if (preg_match("!^(?<id>\d+) skipmap (?<ip>[a-zA-Z0-9\.-]+:\d+)$!", $text, $preg)) {
                                $match = \eBot\Manager\MatchManager::getInstance()->getMatch($preg["ip"]);
                                if ($match) {
